...
void wasm4_blit (const uint8_t* data, int32_t x, int32_t y, uint32_t width, uint32_t height, uint32_t flags);

/** Copies a subregion within a larger sprite atlas to the framebuffer. */
void wasm4_blitSub (const uint8_t* data, int32_t x, int32_t y, uint32_t width, uint32_t height,
...
/** Plays a sound tone. */
void wasm4_tone (uint32_t frequency, uint32_t duration, uint32_t volume, uint32_t flags);
